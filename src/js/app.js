...
$(function () {
  $(".learning-about .learning-about__item:nth-child(1) .learning-about__header"),
      $(".learning-about__header").on("click", function () {
        $(".icon-plus").removeClass("active")
          $(this).hasClass("active")
              ? ($(this).siblings(".learning-about__content").slideUp(), $(this).removeClass("active"), $(this).find(".icon-plus").removeClass("active"))
              : ($(".learning-about__content").slideUp(), $(".learning-about__header").removeClass("active"), $(this).siblings(".learning-about__content").slideToggle(), $(this).toggleClass("active"), $(this).find(".icon-plus").addClass("active"));
      });
})
